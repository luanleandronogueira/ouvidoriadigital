...
if(isset($_GET['tipo']) && $_GET['tipo'] == 'anonima') {
    
    $minhas_manifetacoes = $manifestacoes->chama_manifestacao_anonima($_SESSION['id_entidade']);

} else if(isset($_GET['tipo']) && $_GET['tipo'] == 'analise_aberta'){

    $minhas_manifetacoes = $manifestacoes->chama_manifestacao_aberto_analise($_SESSION['id_entidade']);

} else {

    $minhas_manifetacoes = $manifestacoes->chama_manifestacao_concluida($_SESSION['id_entidade']);
}
