...
//     if (
//         $_FILES['arquivo_manifestacao']['type'] == 'application/pdf' ||
...
<div class="revisar">
    ...
    <div class="revisar-conteudo">
        ...
        <div class="revisar-info">
            <h4>Destinatário:</h4> <?= $_SESSION['entidade_nome'] /*$_POST['entidade_manifestacao']*/ ?>
        </div>
        <div class="revisar-info">
    ...
    <form action="provedores/CadastraManifestacao.php" method="post" enctype="multipart/form-data">
        ...
        <div class="revisar-botoes">
            ...
            <button type="submit" onclick="enviaLocalizacao()" class="btn btn-primary btn1">Enviar Manifestação</button>
        </div>
    </form>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', (event) => {
        const latSalva = getCookie('latitude');
        const lonSalva = getCookie('longitude');

        document.getElementById('latitude').value = latSalva
        document.getElementById('longitude').value = lonSalva

        console.log(latSalva)
        console.log(lonSalva)
    })
</script>
